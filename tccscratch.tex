...
\begin{table}[H]
        ...
        \begin{tabular}{ >{\centering\arraybackslash}m{2.5cm} >{\centering\arraybackslash}m{6cm} >{\centering\arraybackslash}m{6.5cm}}
            ...
            \midrule
            \textbf{2} & Contando Histórias & Contar uma história através da programação do Scratch \\
            \midrule
            \textbf{3} & Programação de jogos & Desenvolver um jogo com a programação do Scratch \\
            \midrule
            \textbf{4} & Objetos Digitais de Aprendizagem & Conhecer o que são Objetos Digitais de Aprendizagem e como utilizá-los   \\
            \midrule
            \textbf{5} & Programando Objetos Digitais de Aprendizagem & Desenvolver Objetos de Aprendizagem com o Scratch \\
            \midrule
            \textbf{6} & Pensamento Computacional & Resolver problemas usando programação através do Pensamento Computacional como premissa \\
            \midrule
...
Ao final desse primeiro encontro, foi solicitado a cada professor que, até o próximo encontro, examinassem o conteúdo que estavam desenvolvendo em sala e observassem os seus alunos para verificar quais as dificuldades encontradas.
...
Aproveitando a ideia da pequena história desenvolvida no encontro passado, neste segundo encontro os professores programaram histórias animadas mais elaboradas, com movimentos dos \textit{sprites} e com pausas para cada um desses personagens. Utilizaram também as trocas de cenários e de figurinos (no Scratch chamado de fantasias) dos personagens.
...
\begin{figure}[H]
    ...
    \center
    \caption{Exemplo de animação \label{somaesub}}
...
A fase à distância desse encontro foi apresentar aos alunos os Objetos Digitais de Aprendizagem desenvolvidos por eles e fazer uma nova observação da aceitação desta ferramenta e como eles foi o desenvolvimento da aprendizagem de cada aluno.
